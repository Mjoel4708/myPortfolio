export const projects = [
  {
    ...
    description: "Developed a flutterwave payment plugin for shopware 6. This plugin allows shopware 6 merchants to accept payments from their customers using flutterwave payment gateway. The plugin is built using the flutterwave php sdk and the shopware 6 plugin sdk.",
